...
$_lang['userimport.import_users_first_row_headers']             = 'La première ligne contient les en-têtes de colonnes';
$_lang['userimport.import_users_first_row_headers_desc']        = 'Cochez cette case , si la première ligne du fichier CSV contient les en-têtes de colonnes.';
...
$_lang['userimport.import_users_log_err_username_max_len']      = 'Non importé. Longueur maximale du champ identifiant dépassée.';
$_lang['userimport.import_users_log_err_email_max_len']         = 'Non importé. Longueur maximale du champ email dépassée.';
$_lang['userimport.import_users_log_err_fullname_max_len']      = 'Non importé. Longueur maximale du champ nom complet dépassée.';
$_lang['userimport.import_users_log_err_address_max_len']       = 'Non importé. Longueur maximale du champ adresse dépassée.';
$_lang['userimport.import_users_log_err_country_max_len']       = 'Non importé. Longueur maximale du champ pays dépassée.';
$_lang['userimport.import_users_log_err_city_max_len']          = 'Non importé. Longueur maximale du champ ville dépassée.';
$_lang['userimport.import_users_log_err_state_max_len']         = 'Non importé. Longueur maximale du champ région dépassée.';
$_lang['userimport.import_users_log_err_zip_max_len']           = 'Non importé. Longueur maximale du champ code postal dépassée.';
$_lang['userimport.import_users_log_err_phone_max_len']         = 'Non importé. Longueur maximale du champ téléphone dépassée.';
$_lang['userimport.import_users_log_err_mobilephone_max_len']   = 'Non importé. Longueur maximale du champ mobile dépassée.';
$_lang['userimport.import_users_log_err_fax_max_len']           = 'Non importé. Longueur maximale du champ fax dépassée.';
$_lang['userimport.import_users_log_err_website_max_len']       = 'Non importé. Longueur maximale du champ site web dépassée.';
